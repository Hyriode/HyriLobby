...
import fr.hyriode.lobby.ui.item.hotbar.*;
import fr.hyriode.lobby.ui.item.queue.LeaveQueueItem;
import fr.hyriode.lobby.minigame.jump.LobbyJump;
import fr.hyriode.lobby.minigame.jump.item.LobbyJumpCheckPointItem;
import fr.hyriode.lobby.minigame.jump.item.LobbyJumpLeaveItem;
...
public class LobbyPlayer {
    ...
    public void startJump() {
        HyriCosmetics.get().getUserProvider().getUser(getUniqueId()).temporarilyUnequipCosmetics();
