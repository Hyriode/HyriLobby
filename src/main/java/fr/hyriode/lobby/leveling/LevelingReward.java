...
public enum LevelingReward {
    ...
    LEVEL_11(11, new HyodesHandler(100L)),
    LEVEL_12(12, new BoosterHandler(new BoosterHandler.Data(1, 1.75D, 3600))),
    LEVEL_13(13, new ExperienceHandler(1000.0D)),
    ...
    LEVEL_32(32, new HostHandler(1)),
    LEVEL_33(33, new HyodesHandler(100L)),
    ...
    private static class HyodesHandler extends Handler<Long> {

        public HyodesHandler(Long data) {
            super("hyodes", data);
        }
    ...
    private static class ExperienceHandler extends Handler<Double> {

        public ExperienceHandler(Double data) {
            super("experience", data);
        }
