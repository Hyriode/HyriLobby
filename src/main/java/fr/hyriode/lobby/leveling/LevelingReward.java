...
public enum LevelingReward {
    ...
    LEVEL_8(8, new BoosterHandler(new BoosterHandler.Data(1, 1.75D, 3600, IHyriBoosterManager.SELECTABLE_TYPE))),
    LEVEL_9(9, new HyrisHandler(2800L)),
    LEVEL_10(10, new LootboxHandler(new LootboxHandler.Data(HyriLootboxRarity.ONE_STAR, 2))),
    LEVEL_11(11, null),
    LEVEL_12(12, new BoosterHandler(new BoosterHandler.Data(1, 1.75D, 3600, IHyriBoosterManager.SELECTABLE_TYPE))),
    LEVEL_13(13, null),
    ...
    LEVEL_17(17, new BoosterHandler(new BoosterHandler.Data(1, 1.75, 7200, IHyriBoosterManager.SELECTABLE_TYPE))),
    LEVEL_18(18, new CosmeticHandler(0L)),
    LEVEL_19(19, new HyrisHandler(4000L)),
    LEVEL_20(20, new BoosterHandler(new BoosterHandler.Data(1, 1.75, 7200, IHyriBoosterManager.SELECTABLE_TYPE))),
    ...
    LEVEL_23(23, null),
    LEVEL_24(24, new BoosterHandler(new BoosterHandler.Data(1, 1.75, 10800, IHyriBoosterManager.SELECTABLE_TYPE))),
    ...
    LEVEL_30(30, new BoosterHandler(new BoosterHandler.Data(1, 1.75, 10800, IHyriBoosterManager.SELECTABLE_TYPE))),
    LEVEL_31(31, new HyrisHandler(6000L)),
    LEVEL_32(32, null),
    LEVEL_33(33, null),
    LEVEL_34(34, new BoosterHandler(new BoosterHandler.Data(1, 1.75, 14400, IHyriBoosterManager.GLOBAL_TYPE))),
    ...
    LEVEL_39(39, new BoosterHandler(new BoosterHandler.Data(1, 2.25D, 3600, IHyriBoosterManager.SELECTABLE_TYPE))),
    ...
    LEVEL_44(44, new BoosterHandler(new BoosterHandler.Data(1, 2.25D, 3600, IHyriBoosterManager.SELECTABLE_TYPE))),
    LEVEL_45(45, null),
    LEVEL_46(46, new HyrisHandler(9000L)),
    LEVEL_47(47, new CosmeticHandler(0L)),
    LEVEL_48(48, new BoosterHandler(new BoosterHandler.Data(1, 2.25D, 7200, IHyriBoosterManager.SELECTABLE_TYPE))),
    ...
    LEVEL_53(53, new BoosterHandler(new BoosterHandler.Data(1, 2.25D, 7200, IHyriBoosterManager.SELECTABLE_TYPE))),
    LEVEL_54(54, null),
    ...
    LEVEL_58(58, new BoosterHandler(new BoosterHandler.Data(1, 2.25D, 10800, IHyriBoosterManager.SELECTABLE_TYPE))),
    ...
    LEVEL_64(64, new BoosterHandler(new BoosterHandler.Data(1, 2.25D, 10800, IHyriBoosterManager.SELECTABLE_TYPE))),
    ...
    LEVEL_71(71, new BoosterHandler(new BoosterHandler.Data(1, 2.25D, 14400, IHyriBoosterManager.GLOBAL_TYPE))),
    LEVEL_72(72, new HyrisHandler(11000L)),
    LEVEL_73(73, null),
    LEVEL_74(74, new BoosterHandler(new BoosterHandler.Data(1, 2.75D, 3600, IHyriBoosterManager.SELECTABLE_TYPE))),
    ...
    LEVEL_79(79, new BoosterHandler(new BoosterHandler.Data(1, 2.75D, 3600, IHyriBoosterManager.SELECTABLE_TYPE))),
    LEVEL_80(80, null),
    ...
    LEVEL_85(85, new BoosterHandler(new BoosterHandler.Data(1, 2.75D, 7200, IHyriBoosterManager.SELECTABLE_TYPE))),
    ...
    LEVEL_90(90, new BoosterHandler(new BoosterHandler.Data(1, 2.75D, 7200, IHyriBoosterManager.SELECTABLE_TYPE))),
    ...
    LEVEL_96(96, new BoosterHandler(new BoosterHandler.Data(1, 2.75D, 10800, IHyriBoosterManager.GLOBAL_TYPE))),
    ...
    private static class BoosterHandler extends Handler<BoosterHandler.Data> {
        ...
        public void claim(IHyriPlayer player) {
            for (int i = 0; i < this.data.getAmount(); i++) {
                HyriAPI.get().getBoosterManager().giveBooster(player, this.data.getType(), this.data.getMultiplier(), this.data.getDuration());
            }
        }
        ...
        public String getDescription(IHyriPlayer player) {
            return this.description.get().getValue(player)
                    ...
                    .replace("%type%", this.data.isGlobal() ? LobbyMessage.BOOSTERS_BOOSTER_GLOBAL.asString(player) : LobbyMessage.BOOSTERS_BOOSTER_GAME.asString(player));
        }
        ...
        private static class Data {
            ...
            public Data(int amount, double multiplier, long duration, String type) {
                this.amount = amount;
            ...
            public boolean isGlobal() {
                return this.type.equals(IHyriBoosterManager.GLOBAL_TYPE);
            }
